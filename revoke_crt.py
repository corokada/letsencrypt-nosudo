...
def revoke_crt(pubkey, crt):
    ...
    cmd = "openssl dgst -sha256 -sign user.key -out %s %s" % (crt_file_sig_name, crt_file_name)
...
Example:
--------------
$ python revoke_crt.py --public-key user.pub --csr_path domain.crt
--------------

""")
    parser.add_argument("-p", "--public-key", required=True, help="path to your account public key")
    parser.add_argument("-in", "--crt_path", required=True, help="path to your signed certificate")
